...
?>
		...
		<div class="uk-container">
	        ...
	        <div class="uk-card">
	            ...
	            <div class="uk-card-body">
	                ...
	                <p>グローバル対応を得意としています。翻訳もセットで承ります。</p>
	            </div>
	        </div>
	    	</div>
			</div>
	...
	<section id="pricing" class="uk-section uk-section-default uk-text-center">
		<div class="uk-container">
			...
			<p class="uk-margin">
				お見積もり例です。料金は要件内容によって変動します。より費用を抑えたプランや、納期をお急ぎの場合もご相談可能ですので、詳しくはお問い合わせください。
			</p>
			<div class="uk-child-width-1-3@m uk-child-width-1-1@s" uk-grid uk-height-match=".uk-card">
				<div>
